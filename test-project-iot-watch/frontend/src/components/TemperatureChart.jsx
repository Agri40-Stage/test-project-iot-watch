...
const TemperatureChart = ({ chartData, chartOptions }) => {
  ...
  console.log('TemperatureChart: Received chartData:', chartData);
  console.log('TemperatureChart: Received chartOptions:', chartOptions);
  ...
  console.log('TemperatureChart: Final options:', options);
