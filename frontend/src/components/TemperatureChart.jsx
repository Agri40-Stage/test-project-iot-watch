...
const TemperatureChart = ({ chartData, chartOptions }) => {
  ...
  return (
    <div className="flex flex-col gap-6 lg:col-span-1 py-8 px-6 rounded-xl border border-[var(--border)] bg-[var(--card-bg)] text-[var(--text-primary)] shadow-sm dark:bg-[var(--bg-primary)]">
      <div className="w-full flex flex-col gap-2 text-left">
        <h2 className="text-xl font-medium leading-none">
          Temperature History
        </h2>
        <p className="font-light text-[var(--text-secondary)] text-base leading-none">
